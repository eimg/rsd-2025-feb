import { ScrollView, View, TextInput, TouchableOpacity, ActivityIndicator, KeyboardAvoidingView, Platform } from "react-native";
        ...
        return (
            <ScrollView style={{ padding: 20 }}>
                <View style={{ alignItems: "center", marginBottom: 30 }}>
                    ...
                    <Text style={{ fontSize: 16, color: colors.text + '80', marginTop: 4 }}>@{user.username}</Text>
                </View>
                ...
                <View style={{ 
                    ...
                    <Text style={{ fontSize: 18, fontWeight: 'bold', marginBottom: 10 }}>Bio</Text>
                ...
                {isLoginMode ? (
                    ...
                    <View style={{ gap: 15 }}>
                        ...
                        <TextInput
                            ...
                            onChangeText={(text) => handleRegisterChange("bio", text)}
                            multiline
                            numberOfLines={3}
                            style={{
                                color: colors.text,
